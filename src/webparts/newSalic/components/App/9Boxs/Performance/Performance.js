...
const services = [
  {icon: icons.CreateInvoiceRequest, bgColor: '#1146f7', text: 'Performance Management System (PMS)- Employee', href: 'https://hen.fa.em2.oraclecloud.com/fndSetup/faces/FuseOverview?fndGlobalItemNodeId=EXT_EXTN1521037485862_MENU_1558973037870'},
  {icon: icons.BusinessTripCompletion, bgColor: '#ff22a4', text: 'Performance Management System (PMS)- Managers', href: 'https://hen.fa.em2.oraclecloud.com/fndSetup/faces/FuseOverview?fndGlobalItemNodeId=EXT_EXTN1521037485862_MENU_1558972767621'},
];
