...
const SidebarNav: React.FunctionComponent<SidebarNavProps> = () => {
  const svgIcons = {
    ...
    SALICWebsite: <svg xmlns="http://www.w3.org/2000/svg" version="1.1" fill='#fff' width='35px' viewBox="0 0 97.385 97.385"><g>
        <g xmlns="http://www.w3.org/2000/svg">
          <g>
    ...
    OracleERP: <svg xmlns="http://www.w3.org/2000/svg" version="1.1" fill='#fff' width='35px' viewBox="0 0 511.999 511.999">
          <g>
            <g xmlns="http://www.w3.org/2000/svg">
              <g>
    ...
    OracleReports: <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="35px" viewBox="0 0 512 512">
                    <g>
                      <g xmlns="http://www.w3.org/2000/svg">
    ...
    PowerBi:  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" fill='#fff' width='35px' viewBox="0 0 512 512">
                <g>
                  <g xmlns="http://www.w3.org/2000/svg">
                    <g>
                      <g>
