...
function PersonInfo() {
  const { user_data, notifications_count, mail_count, defualt_route, communicationList } = useContext(AppCtx);
  ...
  return (
    <div className="person">
      ...
      <div className="person-control-buttons person-btns">
        <div className='btns'>
          {
            root?.email?.toLowerCase() === user_data?.Data?.Mail?.toLowerCase() && (
