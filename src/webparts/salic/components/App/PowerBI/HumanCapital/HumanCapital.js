...
const services = [
  {icon: icons.CreateInvoiceRequest, bgColor: '#F7937B', isLink: false, text: 'HR Dashboard', to: '/power-bi-dashboards/human-capital/hr-dashboard'},
  {icon: icons.CreateInvoiceRequest, bgColor: '#43A2CC', isLink: false, text: 'Employee Analytics Dashboard', to: '/power-bi-dashboards/human-capital/employee-analytics-dashboard'},
];
