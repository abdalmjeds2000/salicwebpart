...
const svgIcons = {
  ...
  communication: (
    <svg
      id="Iconly_Light_Calling"
      data-name="Iconly/Light/Calling"
      xmlns="http://www.w3.org/2000/svg"
      width="35"
      height="35"
      viewBox="0 0 35 35"
    >
      <g id="Calling" transform="translate(3.646 3.646)">
        <path
          id="Stroke_1"
          data-name="Stroke 1"
          d="M.715,3.461C1.176,2.7,3.719-.082,5.531,0A2.4,2.4,0,0,1,6.942.755h0c.893.875,3.454,4.175,3.6,4.87.355,1.7-1.677,2.687-1.056,4.4A14.4,14.4,0,0,0,17.68,18.22c1.716.623,2.7-1.408,4.4-1.054.695.145,4,2.7,4.871,3.6h0a2.39,2.39,0,0,1,.753,1.411c.067,1.909-2.883,4.487-3.458,4.816-1.357.972-3.127.954-5.286-.049C12.941,24.437,3.316,14.995.764,8.745-.213,6.6-.279,4.817.715,3.461Z"
        ...
        <path
          id="Path"
          d="M0,0A11.624,11.624,0,0,1,10.268,10.255"
          transform="translate(17.595 0.365)"
          fill="none"
          stroke="#fff"
          stroke-linecap="round"
          stroke-linejoin="round"
        ...
        <path
          id="Path-2"
          data-name="Path"
          d="M0,0A6.454,6.454,0,0,1,5.1,5.1"
          transform="translate(17.595 5.531)"
          fill="none"
          stroke="#fff"
          stroke-linecap="round"
          stroke-linejoin="round"
  ...
  performance: (
    ...
    >
      <g>
        <g xmlns="http://www.w3.org/2000/svg">
          <path
            d="m241 35.154c-57.822 3.319-112.046 25.788-155.327 64.361l66.936 66.936c25.19-20.971 55.776-33.644 88.391-36.624z"
            fill="#FFFFFF"
          ></path>
          <path
            d="m131.389 187.657-66.935-66.935c-38.606 43.269-61.103 97.497-64.443 155.333h94.677c3-32.621 15.7-63.21 36.701-88.398z"
            fill="#FFFFFF"
          ></path>
          <path
            d="m417.312 276.055h94.677c-3.34-57.836-25.836-112.064-64.443-155.333l-66.935 66.935c21.001 25.187 33.701 55.777 36.701 88.398z"
            fill="#FFFFFF"
          ></path>
          <path
            d="m417.291 306.055c-2.103 23.103-8.696 42.373-16.494 57.83 7.607 11.731 13.949 21.645 18.139 28.229 11.41 17.932 8.884 40.95-6.144 55.979-3.649 3.649-7.817 6.589-12.334 8.762l15.589 15.59c2.934 2.934 6.78 4.401 10.625 4.401 3.846 0 7.691-1.467 10.624-4.401 44.924-44.919 71.119-103.534 74.704-166.39z"
            fill="#FFFFFF"
          ></path>
          <path
            d="m94.71 306.055h-94.71c3.585 62.856 29.78 121.471 74.703 166.391 2.934 2.934 6.779 4.401 10.624 4.401s7.691-1.468 10.625-4.401l45.512-45.515c5.867-5.868 5.867-15.382 0-21.25-11.877-11.877-41.794-45.129-46.754-99.626z"
            fill="#FFFFFF"
          ></path>
          <path
            d="m426.327 99.515c-43.281-38.574-97.505-61.042-155.327-64.361v94.673c32.614 2.98 63.201 15.653 88.391 36.624z"
            fill="#FFFFFF"
          ></path>
          <path
            d="m289.33 257.977c-18.377-18.377-48.279-18.377-66.656 0s-18.377 48.279 0 66.656c23.216 23.216 137.311 96.066 150.245 104.296 5.931 3.775 13.688 2.923 18.66-2.048 4.971-4.971 5.823-12.728 2.048-18.66-8.231-12.933-81.081-127.029-104.297-150.244z"
            fill="#FFFFFF"
          ></path>
        </g>
      </g>
      ...
      <g>
        <g xmlns="http://www.w3.org/2000/svg">
          <g>
            <g>
              <path
                d="M116,256c0-37.42,14.562-72.6,41.005-99.059c7.811-7.816,7.811-20.488,0-28.303c-7.81-7.817-20.473-7.817-28.284-0.001     C94.723,162.657,76,207.888,76,256s18.723,93.343,52.721,127.363c7.81,7.815,20.473,7.815,28.284-0.001     c7.811-7.815,7.811-20.487,0-28.303C130.562,328.6,116,293.42,116,256z"
                fill="#FFFFFF"
              ></path>
              <path
                d="M40,256c0-57.734,22.468-112.012,63.264-152.835c7.811-7.816,7.811-20.488,0-28.304c-7.811-7.815-20.474-7.815-28.284,0     C26.628,123.246,0,187.575,0,256s26.628,132.754,74.981,181.139c7.809,7.814,20.473,7.816,28.284,0     c7.811-7.816,7.811-20.488,0-28.304C62.468,368.012,40,313.734,40,256z"
                fill="#FFFFFF"
              ></path>
              <path
                d="M256,151.932c-57.346,0-104,46.685-104,104.068s46.654,104.068,104,104.068S360,313.383,360,256     S313.346,151.932,256,151.932z M256,320.042c-35.29,0-64-28.729-64-64.042s28.71-64.042,64-64.042c35.29,0,64,28.729,64,64.042     S291.29,320.042,256,320.042z"
                fill="#FFFFFF"
              ></path>
              <path
                d="M437.018,74.861c-7.81-7.816-20.473-7.815-28.284,0.001c-7.811,7.816-7.81,20.487,0.001,28.303     C449.532,143.988,472,198.266,472,256s-22.468,112.012-63.264,152.835c-7.811,7.816-7.812,20.487-0.001,28.303     c7.808,7.814,20.471,7.819,28.284,0.001C485.371,388.754,512,324.425,512,256S485.371,123.246,437.018,74.861z"
                fill="#FFFFFF"
              ></path>
              <path
                d="M383.278,128.637c-7.81-7.816-20.473-7.815-28.284,0.001c-7.811,7.816-7.81,20.487,0.001,28.303     C381.437,183.4,396,218.58,396,256c0,37.42-14.562,72.6-41.005,99.059c-7.811,7.816-7.812,20.487-0.001,28.303     c7.808,7.814,20.471,7.819,28.284,0.001C417.276,349.343,436,304.112,436,256S417.276,162.657,383.278,128.637z"
                fill="#FFFFFF"
              ></path>
            </g>
          </g>
  ...
  SignOut: (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M554.666667 128l-85.333333 0 0 426.666667 85.333333 0L554.666667 128zM760.746667 220.586667l-60.586667 60.586667C767.573333 335.36 810.666667 418.56 810.666667 512c0 165.12-133.546667 298.666667-298.666667 298.666667s-298.666667-133.546667-298.666667-298.666667c0-93.44 43.093333-176.64 110.08-231.253333L263.253333 220.586667C180.48 290.986667 128 395.093333 128 512c0 212.053333 171.946667 384 384 384 212.053333 0 384-171.946667 384-384C896 395.093333 843.52 290.986667 760.746667 220.586667z" />
    </svg>
  ),
};
...
const SidebarNav = (props) => {
  ...
  return (
    <>
      {activeRoute !== "/sites/dev/SitePages/Demo.aspx/home" && (
        <SimpleUserPanel />
      )}
      <nav
        className={
          isNavBarLarge
            ? "nav-container nav-container-large"
      ...
      >
        <div
          className="nav-open"
          onClick={() => setIsNavBarLarge(!isNavBarLarge)}
        >
        ...
        <ul
          style={
            windowSize.innerWidth < 800 && !isNavBarLarge
              ? { display: "none" }
              : {}
          }
        >
