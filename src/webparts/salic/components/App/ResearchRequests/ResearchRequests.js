...
function ResearchRequests() {
  ...
  const services = [
    {icon: srvsIcons.servicesRequest, to: '/research-requests/new-request', bgColor: '#70CFAF', text: 'New Research Request'},
    ...
    <>
      ...
      <div className='services-page-container'>
        ...
        <div className='services-body-container'>
          ...
          <div className="services-boxs-container">
            <a className='box' onClick={() => navigate(defualt_route + '/research-requests/my-research-requests')}>
              <div style={{backgroundColor: '#43A2CC'}}>
                {srvsIcons.servicesRequest}
              </div>
              <h3>My Research Requests</h3>
            </a>
            <a className='box' onClick={() => navigate(defualt_route + '/research-requests/all-research-requests')}>
