    ...
    <>
      ...
      <div className='standard-page'>
        <ServicesSection
          ...
          items={[
            {icon: CreateInvoiceRequest, isLink: false, to: '/incidents-center/new-report', bgColor: '#FF6699', text: 'New Incident Report'},
          ]}
        />
        <ServicesSection
          title="Request Center"
          items={[
            {icon: CreateInvoiceRequest, isLink: false, to: '/incidents-center/my-reports', bgColor: '#9922FF', text: 'My Requests'},
            {icon: CreateInvoiceRequest, isLink: false, to: '/incidents-center/assigned-reports', bgColor: '#3366FF', text: 'Assigned To Me'},
            {icon: CreateInvoiceRequest, isLink: false, to: '/incidents-center/request-for-review', bgColor: '#FFaa00', text: 'Requests For Review'},
          ]}
        />
      </div>
    </>
