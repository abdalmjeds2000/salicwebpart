...
function ManageDashboardData() {
  ...
  const services = [
    {icon: srvsIcons.servicesRequest, to: '/manage-research-library/research-articles', bgColor: '#55b8a9', text: 'Research Reports'},
    {icon: srvsIcons.servicesRequest, to: '/manage-research-library/research-news', bgColor: '#ad85f3', text: 'News'},
