...
function ManageDashboardData() {
  ...
  const services = [
    {icon: srvsIcons.servicesRequest, to: '/manage-research-library/research-articles', bgColor: '#55b8a9', text: 'Research Articles'},
    {icon: srvsIcons.servicesRequest, to: '/manage-research-library/research-news', bgColor: '#ad85f3', text: 'Research News'},
    {icon: srvsIcons.servicesRequest, to: '/manage-research-library/research-pulse', bgColor: '#ff8084', text: 'Research Pulse'},
    {icon: srvsIcons.servicesRequest, to: '/manage-research-library/research-country', bgColor: '#4f6bed', text: 'Research Country Outlook'},
      ...
      <div className='services-page-container'>
        ...
        <div className="header">
          <div style={{backgroundColor: '#897ED4'}}>
            {srvsIcons.servicesRequest}
          </div>
          <h2>Manage Research Library Content</h2>
        </div>
          ...
          <div className="services-boxs-container">
            {services.map((service, i) => {
              return (
                <a
                  key={i}
                  onClick={() => navigate(defualt_route + service.to)}
                  className='box' 
                >
