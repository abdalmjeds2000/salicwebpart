...
function ResearchRequests() {
  ...
  const services = [
    {icon: srvsIcons.servicesRequest, isLink: false, to: '/research-requests/new-request', bgColor: '#70CFAF', text: 'New Research Request'},
    ...
    <>
      ...
      <div className='standard-page'>
        ...
        <ServicesSection
          ...
          items={[
            {icon: srvsIcons.servicesRequest, isLink: false, to: '/research-requests/my-research-requests', bgColor: '#43A2CC', text: 'My Research Requests'},
            {icon: srvsIcons.servicesRequest, isLink: false, to: '/research-requests/all-research-requests', bgColor: '#FD96A6', text: 'Research Requests'},
          ]}
        />
      </div>
    </>
